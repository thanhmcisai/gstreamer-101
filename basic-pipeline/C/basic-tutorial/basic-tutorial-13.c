...
int tutorial_main(int argc, char *argv[])
{
    ...
    /* Build the pipeline */
    /* Changing the playback rate might only work with local files.
    If you cannot modify it, try changing the URI passed to playbin
    in line 114 to a local URI, starting with file:/// */
    data.pipeline =
